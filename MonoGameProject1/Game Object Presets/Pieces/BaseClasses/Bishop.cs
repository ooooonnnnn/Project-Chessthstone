...
public class Bishop(bool isWhite, int baseHealth, int baseDamage, bool isSpecial = false) 
	: ChessPiece(isWhite, PieceType.Bishop, baseHealth, baseDamage, isSpecial)
{
