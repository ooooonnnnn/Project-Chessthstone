...
public class Knight(bool isWhite, int baseHealth, int baseDamage, bool isSpecial = false)
	: ChessPiece(isWhite, PieceType.Knight, baseHealth, baseDamage, isSpecial)
{
